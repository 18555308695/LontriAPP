...
(function($, window, document) {
	...
	//fixed hashchange(android)
	window.addEventListener($.EVENT_CLICK, function(e) {
		// if (cell && cell.classList.contains('mui-collapse') && !cell.hasOwnProperty("skipCheck")) {
		// 	e.preventDefault();
		// }
		if (cell && cell.classList.contains('mui-collapse')&& !cell.classList.contains("skincheck")){
			e.preventDefault();
		}
	});
